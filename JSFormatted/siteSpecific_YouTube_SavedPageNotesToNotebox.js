...
`;
 ...
 function copyNotesSavedPageNotes() {
 ...
 const addKeyDownSavedPageNotes = () => { document.body.addEventListener("keydown", function() {
  keypressToNoteSavedPageNotes();  
  }); 
 }; 
 const addKeyUpSavedPageNotes = () => { document.body.addEventListener("keyup", function() {
  keypressToNoteSavedPageNotes();
  }); 
 };
...
/* 
 ...
 usename--Video-Title
*/
var storedNotes = localStorage.getItem(storageVar);
if (storedNotes == null ||
