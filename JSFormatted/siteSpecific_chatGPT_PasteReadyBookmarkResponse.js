javascript:(function(){ 
 ...
 var ButtonClassNameIdentifier = "rounded-md p-1 text-token-text-tertiary"; /* THIS IS HIGHLY LIKELY TO CHANGE */
 
 /* Class names to identify div that is parent of button row. */
 var DivClassNameIdentifier = "-ml-1 mt-0 h-7 items-center justify-center"; /* THIS IS HIGHLY LIKELY TO CHANGE */
