javascript:(function() {
 ...
 promptTextarea.style.resize = "horizontal"; 
 promptTextarea.style.padding = "100px";
 subButton.style.right = "unset";
 subButton.style.left = "10px";
 subButton.style.bottom = "0px";
