...
- [DOM Bookmarklets](#dom-bookmarklets)
  ...
  - [Search - Search Page](#search---page) - ready to use 
...
Search long documentation pages <br><br>
...
Gist page for [dom_search_page.js](https://gist.github.com/jhauga/CHANGE_ID)
